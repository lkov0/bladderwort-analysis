...
# Make multiple genome alignment and do PhastCons
...
aligndir=$parentdir/ConservationAnalysis_asterids
combinedir=$aligndir/Multiple_Alignment_asterids
...
TREEROSID="(KalanchoeFedtschenkoi (((CaricaPapaya ArabidopsisThaliana) DurioZibethinus) ((CannabisSativa PrunusPersica) (GlycineMax MedicagoTruncatula) BetulaPendula CitrullusLanatus ManihotEsculenta) VitisVinifera))"
